...
import fr.univ_artois.lgi2a.similar.extendedkernel.environment.IEnvNaturalModel;
 ...
 */
public class EnvNaturalInChamber2 implements IEnvNaturalModel {
	/**
	 * {@inheritDoc}
	 */
	@Override
	public LevelIdentifier getLevel() {
		return BubbleChamberLevelList.CHAMBER;
	}
