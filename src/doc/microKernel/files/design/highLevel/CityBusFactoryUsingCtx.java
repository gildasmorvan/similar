 ...
 */
public class CityBusFactoryUsingCtx {
   /**
    * The instance of this singleton class. Use this field to call the generation methods 
    * of this factory.
    */
   private static final CityBusFactoryUsingCtx INSTANCE = new CityBusFactoryUsingCtx( );
    ...
    */
   public static CityBusFactoryUsingCtx instance( ) {
      return INSTANCE;
   }
   ...
   /**
    * Generates a "City bus" agent using the ctx context-dependent parameter 
    * to initialize the agent with a specific speed in the city level.
