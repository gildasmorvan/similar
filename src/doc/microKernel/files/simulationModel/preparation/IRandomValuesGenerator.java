...
public interface IRandomValuesGenerator {
	...
	/**
	 * Gets a random integer value between 0 (included) and the specified 
	 * higher bound (excluded).
	 * @param higherBound The higher bound used for random integer generation.
	 * @return a random integer value between 0 (included) and 
	 * <code>higherBound</code> (excluded).
	 */
